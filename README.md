...
### 10. P2P 同期リスニング & DJ Room (WebRTC / PeerJS)
- **6桁コード接続**: サーバーレスでワンタップ暗号化 P2P 接続。
- **ミリ秒再生同期**: ネットワーク遅延 (RTT) を自動補正し、再生・一時停止・シークを完全同期。
- **リクエストキュー & 投票**: 参加者による曲リクエストと Upvote 投票キュー。
- **DJ アナウンス & チャット**: リアルタイム曲紹介テロップとチャットタイムライン。
